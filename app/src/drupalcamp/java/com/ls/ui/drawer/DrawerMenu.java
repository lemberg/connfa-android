...
//        result.add(new DrawerMenuItem(context.getString(R.string.social_events), R.drawable.menu_icon_social, R.drawable.menu_icon_social_sel, EventMode.Social, false));
        ...
        result.add(new DrawerMenuItem(context.getString(R.string.floor_plan), R.drawable.menu_icon_floor_plan, R.drawable.menu_icon_floor_plan_sel, DrawerMenu.EventMode.FloorPlan, false));
        ...
        result.add(new DrawerMenuItem(context.getString(R.string.speakers), R.drawable.menu_icon_speakers, R.drawable.menu_icon_speakers_sel, DrawerMenu.EventMode.Speakers, true));
