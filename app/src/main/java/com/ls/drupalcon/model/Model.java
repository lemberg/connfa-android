...
public class Model {
    ...
    private SharedFavoriteManager sharedFavoriteManager;
    ...
    public SharedFavoriteManager getSharedFavoriteManager() {
    ...
    private Model(Context context)
    {
        ...
        sharedFavoriteManager =  new SharedFavoriteManager();
